...
import com.rsdesign.wallpaper.model.categoryWallpaper.Wallpaper;
import com.rsdesign.wallpaper.util.utils;

import java.util.List;

public class ShowCategoryPhotoAdapterWithAd extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setOnClickPhoto(ShowCategoryPhotoAdapterWithAd.OnClickPhoto onClickPhoto) {
        this.onClickPhoto = onClickPhoto;
    }


    public ShowCategoryPhotoAdapterWithAd(List<Object> allResultList, Context context) {
